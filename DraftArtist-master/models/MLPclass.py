...
# The classifier uses two arrays as its input array1 consist of (n_samples, n-features) there samples is our training data
# and features is the features we have in the sample
